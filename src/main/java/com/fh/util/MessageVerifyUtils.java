...
public class MessageVerifyUtils {
    ...
    static final String accessKeyId = "LTAI4G9zT2pEASvcviCxDB8r";           // TODO 改这里
    static final String accessKeySecret = "ZCcAk8W9o8ImcJP1VWhZHivesHkg3u"; // TODO 改这里
    ...
    public static SendSmsResponse sendSms(String userPhone, String userCode) throws ClientException {
        ...
        // 必填:短信签名-可在短信控制台中找到
        request.setSignName("某某商场"); // TODO 改这里
        // 必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_196658059");  // TODO 改这里
